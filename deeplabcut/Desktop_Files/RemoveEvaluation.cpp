...
using namespace std;
int main(){
	string project_path="C:\\Users\\user\\Desktop\\Video_files_Deeplabcut\\LinearChamber\\";
	...
	Search_path.push_back(project_path + Experiment_Days[0]);
		...
		for(int i=0;i<File_paths.size();i++){
			size_t label_found=File_paths[i].find("resnet");
